  ...
  return (
    ...
    >
      ...
      //  options={{title:'Tab1', tabBarIcon: ({color}) => (<Text style={{color}}>Tab1</Text>)}} 
       options={{title:'Tab1', tabBarIcon: ({color}) => (<IonIcon name='american-football-outline' color={color}/>)}} 
      ...
      //  options={{title:'Tab3', tabBarIcon: ({color}) => (<Text style={{color}}>Tab3</Text>)}} 
       options={{title:'Tab3', tabBarIcon: ({color}) => (<IonIcon name='chatbox-outline' color={color}/>)}} 
